          ...
          <CometCard className=" ">
            <div className="relative ring-4 ring-white rounded">
              ...
              <Image
                ...
                width={640}
                height={263}
                className="absolute bottom-[7%] left-1/2 z-10 w-[92%] -translate-x-1/2"
              />

              <span className="absolute bottom-[23%] left-1/2 -translate-x-1/2 text-xl text-white z-10 tracking-wide font-medium text-center w-10/12">
              ...
              <img
                ...
                width={128}
                height={128}
                className="absolute bottom-[11.2%] left-[49.55%] z-10 w-[17.5%] -translate-x-1/2 rounded-full"
              />
              ...
              <img
                ...
                width={40}
                height={40}
                className="absolute  bottom-[13.4%] left-[73.55%] z-10 w-[9.3%] -translate-x-1/2 "
              />
              ...
              <img
                ...
                width={40}
                height={40}
                className="absolute bottom-[13.4%] left-[85.6%] z-10 w-[9.3%] -translate-x-1/2 "
              />
              ...
              <img
                ...
                width={50}
                height={50}
                className="absolute bottom-[12.9%] left-[15.4%] z-10 w-[10.3%] -translate-x-1/2 "
              />
              ...
              <img
                ...
                width={50}
                height={50}
                className="absolute bottom-[12.9%] left-[23.5%] z-10 w-[6.5%] -translate-x-1/2 "
              />
              ...
              <span className="absolute bottom-[5%] left-1/2 -translate-x-1/2 text-xl text-white z-10 text-center w-10/12">
                {data.summonerName}
              </span>
            </div>
          </CometCard>
